 ...
 * <p>
 * To use it one has to register the module and then render {@link Template3} instances.
 * Instances of {@code Template} can be created using one of the
 * {@link Template3#thymeleafTemplate(String, Map)}
 * static methods.
 * <p>
...
public final class Thymeleaf3Module extends ConfigurableModule<Thymeleaf3Module.Config> {
  ...
  public static class Config {
     ...
     * <p>
     * {@value Thymeleaf3Module#DEFAULT_TEMPLATE_MODE} by default.
     *
     ...
     * <p>
     * {@value Thymeleaf3Module#DEFAULT_TEMPLATE_PREFIX} by default.
     *
     ...
     * <p>
     * {@value Thymeleaf3Module#DEFAULT_TEMPLATE_SUFFIX} by default.
     *
